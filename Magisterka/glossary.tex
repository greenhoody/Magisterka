...
\newacronym{PPO}{PPO}{Procimal Policy Optimization}
\newacronym{RL}{RL}{Uczenie ze wzmocnieniem}
\newacronym{PReLU}{PReLU}{Parametric ReLU}
\newacronym{SGD}{SGD}{Stochastyczny spadek gradientu}
\newacronym{TD}{TD}{Przyłożenie}
%\newacronym{BN}{BN}
%\newacronym{TRPO}
%\newacronym{API}
%\newacronym{RGB}
