...
gdzie:
\begin{itemize}
	\item $\rho$ (typowo ok. 0.9) — współczynnik wygładzania,
	\item $\epsilon$ — mała stała dla stabilności numerycznej,
