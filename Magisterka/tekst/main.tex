...
\input{tekst/WstępMLP}
\input{tekst/Uczenie_sieci_neuronowych_bez_RL}
\chapter{Sieci Konwolucyjne}
\input{tekst/Sieci_Splotowe}
\chapter{Środowisko testowe}
\input{tekst/BloodBowl}
%\chapter{Sieci Rekurencyjne}
%\chapter{Sieci LSTM GRU}
%\chapter{Zanik Gradientu/Wybuch gradientu}
