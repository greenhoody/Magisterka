...
# My agent 
#Muszę z w action wyciągnąć stan gry. Przerobić na wejście sieci neuronowej i jej wyjście na akcje.
class MyBot(botbowl.Agent):
...
botbowl.register_bot('my-bot', MyBot)
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        home_agent = botbowl.make_bot("my-bot")
