...
plot_name = "botbowl-5"
exp_id_nopf = "e57fe944-38ab-11f0-ba6b-34cff69ad517.dat"
exp_id_pf = "653cb06a-38a5-11f0-a155-34cff69ad517.dat"
window_size = 1
...
# window_size = 100
logfile_nopf = f"logs/{plot_name}/{exp_id_nopf}"
...
plot(
    log_steps=data[:, 2],
    log_mean_reward=data[:, 6],
    log_td_rate=data[:, 4],
    log_win_rate=data[:, 3],
    label="No Pathfinding",
)
...
axs[2].legend(["Baseline", "No Pathfinding"])
