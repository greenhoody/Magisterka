"""
Train PPO with the Spatial Inception policy using the random→checkpoint schedule
...
from ppo_spatial_inception_agent import (
    CNNPolicy,
    InceptionBlock,
    SpatialInceptionBlock as SpatialBlockBase,
)
...
MODEL_KIND = "ppo-spatial-inception-random-checkpoint"
