"""
Train PPO with the ResNet policy using the random→checkpoint schedule that
swaps opponents once the desired performance thresholds are met.
"""
...
from ppo_resNet_agent import CNNPolicy as CNNPolicyResNet, ResidualBlock
...
MODEL_KIND = "ppo-resnet-random-checkpoint"
