"""
Train PPO with the Dynamic Hyper-Connection Spatial Inception policy using the random→checkpoint schedule
...
from ppo_dynamic_hyper_spatial_inception_agent import (
    CNNPolicy,
    PPOAgent,
    HyperConnection,
...
MODEL_KIND = "ppo-dynamic-hyper-random-checkpoint"
