"""
Controlled inception policy with constant spatial width across blocks.
"""
...
class CustomPolicy(nn.Module):
    def __init__(
        ...
        self.spatial = nn.Sequential(
            *[SpatialInceptionBlock(spatial_ch, kernels=block_spec) for block_spec in block_kernels]
        )
